...
srun singularity exec --nv ${CONTAINER_SIF} \
    ...
    --data_dir ${DATA_DIR} \
    --dataset imagenet \
    --job_name resnet_base-newtest5-lr_min_1e-4_fix200_batch600_new_twostage_scheduler_test2 \
    --lr  0.1 \
    --model resnet50 \
    --optimizer sgd_m \
    --random_seed 0 \
    ...
    --train_epochs 300 \
    --trainer base \
    --log_dir logs/resnet/base/resnet_base-newtest5-lr_min_1e-4_fix200_batch600_new_twostage_scheduler_test2/ \
