...
lrs=(0.01 0.05 0.1)  
predicted_nums=(1 3 5)  
predict_epoch_intervals=(1 3 5)
start_epoch_past_weight_pairs=( "10 10" "5 5" "10 5")
  ...
  do
    ...
    do
      ...
      do
        ...
        job_name="pred_conf-lr${lr}-step${predicted_num}-int${predict_epoch_interval}-start${predict_start_epoch}-past${n_past_weights}"
